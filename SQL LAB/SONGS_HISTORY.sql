USE DATABASE SUBQUERY_VS_CTE;

CREATE DATABASE SUBQUERY_VS_CTE;
...
SELECT user_id, COUNT(song_id) AS song_plays
FROM songs_weekly
...
SELECT user_id, song_id, COUNT(song_id) AS song_played
FROM songs_weekly
